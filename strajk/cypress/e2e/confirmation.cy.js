describe('Confirmation spec', () => {
    ...
    it('inputfields should be disabled when booking is confirmed', () => {
        const date = '2023-05-30';
        const time = '18:00'
        const bowlers = 2;
        const lanes = 1;
        ...
        cy.get('.confirmation__input').first().should('be.disabled')
        cy.get('.confirmation__input').eq(1).should('be.disabled')
        cy.get('.confirmation__input').eq(2).should('be.disabled')
        cy.get('.confirmation__input').eq(3).should('be.disabled')
