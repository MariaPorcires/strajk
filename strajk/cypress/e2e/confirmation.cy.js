describe('Confirmation spec', () => {
    beforeEach(() => {
      ...
      it('should fill form and press strike', () => {
        ...
        cy.get('.confirmation__input').eq(3).should('not.have.value', '' )
        cy.get('.confirmation__input').eq(3).invoke('val').should('have.length.greaterThan', 1 )
      })
